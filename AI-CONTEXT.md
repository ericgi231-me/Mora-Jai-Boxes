...
## Project Overview
**Mora Jai Online** - A React-based web game for Mora Jai Boxes from the game Blue Prince
- **Tech Stack**: React + Vite frontend, Docker containerization
- **Deployment**: GitHub Actions CI/CD to home server
