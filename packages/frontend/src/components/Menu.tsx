...
import { MenuOuterBox, LevelGrid, LevelSquare, LocationSection, MenuTitle, MenuDescription, LocationHeader, AccessibleToggleButton } from "../App.styles.tsx";
import { MORA_JAI_BOXES, type MoraJaiBox } from "../boxes.tsx";
import { LOCAL_STORAGE_KEY_ACCESSIBLE, LOCAL_STORAGE_KEY_SOLVED_MAP, useLocalStorageState } from "../helper.tsx";
